...
<head>
  ...
  <title>Pusat Kesehatan Masyarakat</title>
...
<section class="inner-page">
    <div class="container">
        <h2 class="text-center mb-4">Klinik Medis</h2>
        
        <div class="row">
            <div class="col-md-5">
                <img src="assets/img/klinik.jpg" alt="Deskripsi Gambar" class="img-fluid rounded mb-4">
            </div>
            <div class="col-md-7">
                <div class="card">
                    <div class="card-body">
                        ...
                        <ul class="list-unstyled">
                            <li><strong>Konsultasi Medis Umum:</strong> Masalah kesehatan umum seperti flu dan demam.</li>
                            <li><strong>Konsultasi Spesialis:</strong> Dokter spesialis seperti kardiolog dan gastroenterolog.</li>
                            <li><strong>Pemeriksaan Diagnostik:</strong> Tes darah dan urine untuk diagnosis.</li>
                            <li><strong>Imunisasi:</strong> Vaksinasi untuk anak-anak dan dewasa.</li>
                            <li><strong>Layanan Kesehatan Khusus:</strong> Perawatan intensif untuk kondisi tertentu.</li>
                            <li><strong>Penyuluhan Kesehatan:</strong> Informasi tentang pencegahan penyakit dan gaya hidup sehat.</li>
                            <li><strong>Pelayanan Gigi:</strong> Pemeriksaan dan perawatan gigi rutin.</li>
                        </ul>
                    </div>
                </div>
            </div>
